    ...
    <div className="">
      ...
      <div>
        <div className="space-y-2">
          <h3 className="font-manrope font-bold text-[#101928] text-2xl md:text-4xl">
        ...
        <div className="mt-[45px]">
          <label className="block text-sm font-medium font-inter text-[#101928] mb-[20px]">Profile Picture</label>
            ...
            <div className="">
              ...
              >
                ...
                <p className="text-sm font-inter font-medium text-[#98A2B3] mt-2">
                  JPG or PNG file, no larger than 2MB.
                  <br /> (400x400px) with a clean background.
                </p>
              </div>
            </div>
          </div>
        ...
        {(formData?.role === 'user' || user?.role === 'User') && (
          <div className="mt-[59px]">
            <label className="block text-sm font-medium font-inter text-[#101928] mb-3">Service Interests</label>
        ...
        {/* Submit Button and Success Modal */}
        <Button
          variant="primary"
