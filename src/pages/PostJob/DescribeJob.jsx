          ...
          <div className="grid grid-cols-3 gap-4">
            {[0, 1, 2].map((index) => {
              ...
              return (
                <div 
                  key={index} 
                  className={`border border-dashed ${dragActive[index] === 1 ? 'border-pri-norm-1 bg-blue-50' : 'border-gray-300'} rounded-md p-6 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50 h-[140px]`}
                  ...
                  {hasFile ? (
                    <div className="flex flex-col items-center justify-center w-full h-full">
                      {hasPreview ? (
                        ...
                        <>
                          ...
                          <p className="text-xs text-gray-500 truncate w-full text-center max-w-[120px]">{photos[index].name}</p>
                        </>
                      )}
                    </div>
                  ) : (
                    ...
                    <>
                      ...
                      <div className="text-neu-norm-3 text-sm text-center">
                        <span className="text-pri-norm-1">Choose file</span> or<br />
                        drag & drop it here
                      </div>
                    </>
                  )}
