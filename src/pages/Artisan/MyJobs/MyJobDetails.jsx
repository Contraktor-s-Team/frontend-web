          ...
          <div className="bg-white w-full max-w-[584px] rounded-xl p-7">
            ...
            <div className="mt-6 space-y-10.5">
              <div className="space-y-4.25">
                <p className="font-medium text-normal-2">Job Description</p>
                <p className="font-medium">{job?.jobDetails?.jobDescription}</p>
              </div>

              <div className="space-y-4.25">
                <p className="font-medium text-normal-2">Job Location</p>
              ...
              <div className=" space-y-6.5">
                <p className="capitalize flex items-center gap-6 font-medium text-neu-norm-2">
                  ...
                  <div className="flex items-center gap-2.5">
                    <img src={job?.jobDetails?.customerDetails?.image} alt="artisan" className="w-10 h-10 rounded-full" />

                    <div className="text-black">{maskCustomerName(job?.jobDetails?.customerDetails?.name)}</div>
                  </div>
                </p>
                <p className="capitalize flex items-center gap-6 font-medium text-neu-norm-2">
                  <span className="">phone number:</span>
                  <span className="text-black">{maskCustomerNumber(job?.jobDetails?.customerDetails?.phoneNumber)}</span>
                </p>
                <p className="capitalize flex items-center gap-6 font-medium text-neu-norm-2">
                  <span className="">email:</span>
                  <span className="text-black">{maskCustomerEmail(job?.jobDetails?.customerDetails?.email)}</span>
                </p>
                <p className="capitalize flex items-center gap-6 font-medium text-neu-norm-2">
