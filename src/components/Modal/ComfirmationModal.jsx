      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative bg-white rounded-xl shadow-xl max-w-md w-full p-6 transform transition-all">
          ...
          <div className="text-center">
            ...
            {/* Message */}
            <p className="text-sm text-gray-500 mb-6 font-inter">{message}</p>

            {/* Action Buttons */}
            <div className="flex gap-3 justify-center">
              <Button variant="grey-sec" onClick={onClose} disabled={isLoading} className="px-6">
                {cancelText}
              </Button>
              <Button variant="destructive" onClick={onConfirm} disabled={isLoading} className="px-6">
